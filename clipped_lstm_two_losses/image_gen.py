...
parser.add_argument("--names", type=str, default="1")
...
if not os.path.exists("evs_{}".format(args.names)):
    os.makedirs("evs_{}".format(args.names))
...
for epoch in tqdm(stoppings):
    net.load_weights("net_{}/".format(args.names)+str(epoch))
    ...
    plt.savefig("evs_{}/{}.png".format(args.names,epoch))
