...
class Q1(tf.keras.Model):
    def __init__(self):
        ...
        self.l1 = Dense(10, input_shape=(1,),kernel_regularizer=tf.keras.regularizers.l1(0.05),
    activity_regularizer=tf.keras.regularizers.l2(0.05))
        self.l2 = Dense(33, kernel_regularizer=tf.keras.regularizers.l1(0.05),
    activity_regularizer=tf.keras.regularizers.l2(0.05))
        self.l3 = Dense(10, kernel_regularizer=tf.keras.regularizers.l1(0.05),
    activity_regularizer=tf.keras.regularizers.l2(0.05))
        self.l4 = Dense(33, kernel_regularizer=tf.keras.regularizers.l1(0.05),
    activity_regularizer=tf.keras.regularizers.l2(0.05))
        self.l5 = Dense(1, kernel_regularizer=tf.keras.regularizers.l1(0.05),
    activity_regularizer=tf.keras.regularizers.l2(0.05))
