...
parser.add_argument("--its", type=int, default=10**4)

args = parser.parse_args()


net = RNNC(lrr=args.lr, return_sequences=False)
...
dat_set.shuffle(buffer_size=10**8)

l=[]
cuts = len(data_all)/args.bs
ind=0
for k in tqdm(range(int(args.its/cuts))):
